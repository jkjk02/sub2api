...
const adminNavItems = computed((): NavItem[] => {
  ...
  if (authStore.isSimpleMode) {
    ...
    filtered.push({ path: '/admin/claude-stability', label: t('nav.claudeStability'), icon: ShieldIcon })
  ...
  visible.push({ path: '/admin/claude-stability', label: t('nav.claudeStability'), icon: ShieldIcon })
