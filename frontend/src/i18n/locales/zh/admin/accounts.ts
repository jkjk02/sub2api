export default {
    accounts: {
      ...
      oauth: {
        ...
        sessionKeyPreviewLabel: '密钥标识（仅显示前 4 位和后 4 位）',
        keysCount: '{count} 个密钥',
        ...
        authorizing: '授权中...',
        authorizingKey: '授权中 {current}/{total} · {key}',
        ...
        cookieAuthFailedForKey: 'Cookie 授权失败（{key}）：{error}',
        keyAuthFailed: '密钥 {index}（{key}）：{error}',
